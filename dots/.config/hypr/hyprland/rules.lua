...
-- stupid file manager copy
hl.window_rule({match = {title = "^(Copying — Nautilus|Copying — Dolphin)$" }, move = {40, 80}})
...
-- ============ CUSTOMIZATION ZONE ============
-- Add your custom window rules below
-- Examples:
-- hl.window_rule({ match = { class = "firefox" }, float = false, size = {"(monitor_w*0.8)", "(monitor_h*0.8)"} })
-- hl.window_rule({ match = { title = ".*Task.*" }, workspace = 5 })
